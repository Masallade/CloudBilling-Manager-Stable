    ...
    $('#productname-' + cvalue).autocomplete({
        ...
        select: function (event, ui) {
			...
			if(ui.item.data[10] == 'T1'){
				var vat_price = ui.item.data[1]*20/100;
			}else{
				var vat_price = 0;
			}
...
function formatRest(taxFormat, disFormat, trate = '') { console.log(taxFormat);
    var amntArray = [];
    var idArray = [];
    $('.amnt').each(function () {
...
$('#productname-0').autocomplete({
    ...
    select: function (event, ui) {
		...
		if(ui.item.data[10] == 'T1'){
				var vat_price = deciFormat(ui.item.data[1]*20/100);
			}else{
				var vat_price = 0;
			}
		//$('#vat-0').val(vat_price);
...
$('#productname-21').autocomplete({
    ...
    select: function (event, ui) {
		...
		if(ui.item.data[11] == 'T1'){
				var vat_price = deciFormat(ui.item.data[1]*21/100);
			}else{
				var vat_price = 0;
			}
		//$('#vat-0').val(vat_price);
