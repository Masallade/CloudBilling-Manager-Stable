...
ORDER BY id DESC");
    ...
    public function product_stock()
    {
        $query = $this->db->query("
            SELECT 
                SUM(geopos_products.fproduct_price * geopos_products.qty) AS total_salessum,
                SUM(geopos_products.product_price * geopos_products.qty) AS total_purchasesum
