...

{
    ...
    private function _get_datatables_vat_query()

    {

        $this->db->select('geopos_vat_obligations.*');

        $this->db->from('geopos_vat_obligations');
    ...
    function get_vat_datatables($opt = 'all')

    {

        $this->opt = $opt;

        $this->_get_datatables_vat_query();
    ...
    public function addtrans($payer_id, $payer_name, $pay_acc, $date, $debit, $credit, $pay_type, $pay_cat, $paymethod, $note, $eid, $loc = 0, $ty = 0, $is_advance_payment = '', $trans_ref)
    {
    ...
    public function addtrans2($payer_id, $invocieno = 0, $payer_name, $pay_acc, $date, $debit, $credit, $pay_type, $pay_cat, $paymethod, $note, $eid, $loc = 0, $ty = 0, $is_advance_payment = '')
    {
        ...
        if ($pay_acc > 0) {
            ...
            if ($account) {
                ...
                $this->db->insert('geopos_customer_transactions', $data);
