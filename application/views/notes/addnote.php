        ...
        $('.summernote').summernote({
            ...
            callbacks: {
                onKeyup: function(e) {
                    ...
                    var wordLimit = 100; // Set your desired word limit here

                    if (wordCount > wordLimit) {
                    var exceededWords = wordCount - wordLimit;
                    var trimmedContent = content.split(/\s+/).slice(0, wordLimit).join(' ');
                    $(this).summernote('text', trimmedContent);
                    alert('Word limit exceeded! Your content has been trimmed. Exceeded words: ' + exceededWords);
                    }
