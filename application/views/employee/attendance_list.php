<div class="content-body">
            ...
            <div class="card-body">
                ...
                <table id="htable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    <tr>
                        ...
                        <th><?php echo $this->lang->line('StandardHours') ?></th>
    ...
    <script type="text/javascript">
        document.title = '<?php echo $this->lang->line('Attendance'); ?>';
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    ...
                    <h4 class="modal-title"><?php echo $this->lang->line('Delete') . ' ' . $this->lang->line('Attendance'); ?></h4>
                    <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                                aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                <?php echo $this->lang->line('Areyousure') . '<br>' . $this->lang->line('You can not revert'); ?>
                </div>
