                ...
                <form method="post" id="data_form" class="form-horizontal">
                    ...
                    <div class="form-group row">
                        ...
                        <div class="col-sm-4">
                            ...
                            <input type="hidden" value="transactions/create_trans" id="action-url">
...
<script type="text/javascript">
    document.title = '<?php echo $this->lang->line('Add') . ' ' . $this->lang->line('Payroll') . ' ' . $this->lang->line('Transactions') ?>';
