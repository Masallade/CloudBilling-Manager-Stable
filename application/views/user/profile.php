...
.card-header .heading-elements a [class^=ft-] {
    margin-top: 6px;
...
<script>
    document.title = "<?php echo $employee['name'] ?> - <?php echo $this->lang->line('Profile') ?>";
$('body').addClass("vertical-layout vertical-menu-modern 2-columns fixed-navbar  menu-expanded pace-done");
</script>