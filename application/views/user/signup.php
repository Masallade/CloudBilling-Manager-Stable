<div class="content-body">
    ...
    <div class="card card-block bg-white">
        ...
        <form method="post" id="data_form" class="card-body">
            ...
            <h5><?php echo $this->lang->line('Create Account') ?> </h5>
            <hr>
            ...
            <div class="form-group row">
                ...
                <div class="col-sm-4">
                    <input type="submit" id="submit-data" class="btn btn-success margin-bottom"
                        value="<?php echo $this->lang->line('Create Account') ?>"
                        data-loading-text="Creating...">
                    <input type="hidden" value="user/submit_user" id="action-url">
                </div>
            </div>

            <div class="text-center mt-3">
                <span>Already have an account? <a href="<?php echo base_url('user/') ?>" style="text-decoration: underline;">Login here</a></span>
            </div>
...
<script type="text/javascript">
    $("#submit-data").click(function(e) {
        e.preventDefault();
        var actionurl = baseurl + 'signup/submit_user';
