...
<?php
            ...
            if ($this->aauth->premission(1)) { ?>
                <li class="nav-item"><a class="nav-link" href="<?= base_url(); ?>dashboard/"><i
                            class="icon-speedometer"></i><span><?= $this->lang->line('Dashboard') ?></span></a>
                               ...
                               <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i class="ft-list"></i><span><?php echo 'Invoice'; ?></span></a>
                    <ul class="dropdown-menu">
                       ...
                       <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>invoices/create"
                                  ...
                                  <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>invoices/unposted_invoices"
                                                    data-toggle="dropdown"><i class="ft-list"></i><?php echo 'Post Invoices';?></a>
                                                    </li>
                              
                        <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>invoices"
                                                    data-toggle="dropdown"><i class="ft-list"></i><?php echo $this->lang->line('Manage Invoices'); ?></a>
                                                    </li>
                        ...
                        <li class="dropdown dropdown-submenu" data-menu="dropdown-submenu"><a
                            ...
                            <ul class="dropdown-menu">
                                <li data-menu=""><a class="dropdown-item" href="<?= base_url(); ?>purchase/create"
                                                    data-toggle="dropdown"> Create Order</a>
                                </li>
                                <li data-menu=""><a class="dropdown-item" href="<?php echo base_url(); ?>purchase"
                                                    data-toggle="dropdown"><?= $this->lang->line('Manage Orders'); ?></a>
                                </li>
                                <li data-menu="">
                                    <a class="dropdown-item" href="<?= base_url(); ?>purchase/verification" data-toggle="dropdown"></i>Verify Orders</a>
                                </li>
 ...
 if(false) { ?>
             <li class="dropdown nav-item" data-menu="dropdown"><a class="dropdown-toggle nav-link" href="#"
                                                                      data-toggle="dropdown"><i
                                class="icon-note"></i><span>Purchase Orders</span></a>
                    <ul class="dropdown-menu">
                        <li data-menu="">
                            <a class="dropdown-item" href="<?= base_url(); ?>purchase"></i>Manage Purchase Orders</a>
                        </li>
                        <li data-menu="">
                            <a class="dropdown-item" href="<?= base_url(); ?>purchase/verification"></i>Verify Purchase Orders</a>
                        </li>
                    </ul>
            </li>
 <?php } ?>

             <li class="dropdown dropdown-user nav-item" style="position: absolute; right: 18px; top: 50%; transform: translateY(-50%);"><a class="dropdown-toggle nav-link dropdown-user-link"
