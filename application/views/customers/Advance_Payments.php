                ...
                <div class="row">
                    <?php if (!isset($is_ajax) || !$is_ajax): ?>
                        ...
                        <?php else: ?>
                            ...
                            <h5 class="bg-blue bg-lighten-4  p-1 mt-2"> <strong> Advance Payment Balance : <?php echo $cust_amt; ?></strong></h5>
        ...
        <script type="text/javascript">
            ...
            $(document).ready(function() {
                ...
                table = $('#crtstable').DataTable({
                    ...
                    "ajax": {
                        "url": "<?php echo site_url('customers/advancepaymnets_translist') ?>",
                        "type": "POST",
                        "data": {
