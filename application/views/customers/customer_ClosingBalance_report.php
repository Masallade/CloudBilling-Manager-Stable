...
<div class="content-body">
    <div class="card">
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form target="_blank" method="get" action="<?php echo base_url('customers/customer_ClosingBalance_report_export'); ?>">
                    <div class="row">
                        <div class="col-md-2">
                            <input type="date" required class="form-control" name="start_date" max="<?php echo date('Y-m-d'); ?>" />
                        </div>
                        <!-- <div class="col-md-2">
                        ...
                        <!-- <div class="col-md-2">
                    <lable>Zero invoice customers</lable>
                        <input type="checkbox" value="1"  name="check" style="margin-top:5px"/>
                    </div> -->
                        <div class="col-md-2">
                            <input type="submit" class="btn btn-info btn-sm" style="height:31px" />
                        </div>
                    </div>
                </form>
                <br>
                ...
                <table id="clientstable" class="table table-striped table-bordered zero-configuration" cellspacing="0"
                    ...
                    <thead>
                        <tr>
                            ...
                            <th><?php echo 'Balance'; //$this->lang->line('Email') 
                                ?></th>
