<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"> All Customers Balance Report </h4>
...
<div id="delete_model" class="modal fade">
    ...
    <!--change added by me-->
<form method="POST" id="form_for_export" action="<?php echo site_url('customers/customer_balance_report')?>" target="_blank">
