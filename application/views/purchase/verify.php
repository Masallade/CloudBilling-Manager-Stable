        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    <input type="hidden" name="pstatus" value="Verified">
                    <div class="row">
                                ...
                                <table class="tfr">
                                    <tbody>
                                        <tr>
                                            ...
                                            <td align="right">
                                                <span id="overall-total-vat"><?= $invoice['tax'] ?></span>
                                            </td>
                                        </tr>
                                        <tr>
                                            ...
                                            <td align="right"><span id="overall-total"><?= $invoice['total'] - $invoice['tax'] ?></span></td>
                                        </tr>
                                        <tr>
                                            <td class="" style="min-width: 140px"><strong><?php echo $this->lang->line('Grand Total') ?></strong>
                                                (<span class="currenty lightMode"><?php echo $this->config->item('currency'); ?></span>)
                                            </td>
                                            <td align="right"><span id="overall-grand-total"><?= $invoice['total'] ?></span></td>
                                        </tr>
                                    </tbody>
                                </table>
                            </div>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <div class="col-sm-6"><label for="invocieno" class="caption"> <?php echo $this->lang->line('Purchase Order') ?>
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" placeholder="Purchase Order #" name="invocieno" value="<?php echo $invoice['tid']; ?>" readonly><input type="hidden" name="iid" value="<?php echo $invoice['iid']; ?>">
                                            </div>
                                        </div>
                                        ...
                                        <div class="col-sm-6">
                                            <input type="submit" style="float:left; margin-top:24px;" class="btn btn-success sub-btn" value="Verify" id="submit-data" data-loading-text="Creating...">
                                        </div>
                                    </div>
                                    <div class="form-group row">
                        ...
                        <div id="saman-row">
                            <table class="table-responsive tfr">
                                ...
                                <thead>
                                    <tr class="item_header bg-gradient-directional-blue white">
                                        <th width="15%" class="text-center">Product Code</th>
                                        <th width="25%" class="text-center">Product Description</th>
                                        <th width="8.5%" class="text-center">Packing</th>
                                        <th width="8.5%" class="text-center">Units / Pack</th>
                                        <th width="8.5%" class="text-center">Qty / box</th>
                                        <th width="8.5%" class="text-center"><?php echo $this->lang->line('Quantity') ?></th>
                                        <th width="8.5%" class="text-center">Purchase Price</th>
                                        <th width="8.5%" class="text-center">Sales Price</th>
                                        <th width="8.5%" class="text-center">VAT</th>
                                    </tr>
                                </thead>
                                <tbody>
                                    <?php $i = 0;
                            ...
                            <td><input readonly type="text"  id="packing_units-' . $i . '"  name="packing_units[]" class="form-control"  value="' . $row['unit']  . '" autocomplete="off">
                            </td>

                            <td>
                                <input readonly type="text" class="form-control"  value="' . ceil($row['qty'] / $row['unit']) . '" autocomplete="off">
                            </td>

                            <td><input  type="text" class="form-control req amnt" name="product_qty[]" id="amount-' . $i . '" '.(($invoice['verified'] == 'Verified' || $invoice['status'] == 'paid') ? 'readonly' : '').'
                            onkeypress="return isNumber(event)" onkeyup="rowTotal(' . $i . '), billUpyog(), updateOverallTotals()" data-id="' . $i . '"
                            autocomplete="off" value="' . ceil($row['qty']) . '" ><input type="hidden" name="old_product_qty[]" value="' . ceil($row['qty']) . '" ></td>

                            <td>
                                <input type="text"  id="price-' . $i . '"  name="purchase_price[]" class="form-control" '.(($invoice['verified'] == 'Verified' || $invoice['status'] == 'paid') ? 'readonly' : '').' value="' . $row['purchase']  . '" autocomplete="off" onkeyup="updateOverallTotals()" data-id="' . $i . '" >
                            </td>

                            <td>
                                <input type="text"  id="sales_price-' . $i . '"  name="sales_price[]" class="form-control"  value="' . $row['price']  . '" autocomplete="off">
                            </td>

                            <td>
                                <input type="text"  id="vat-' . $i . '"  name="product_tax[]" class="form-control"  value="' . $row['tax']  . '" autocomplete="off" readonly data-id="' . $i . '">
                            </td>
...
<script type="text/javascript">
    function updateOverallTotals() {
        ...
        $('[id^="price-"]').each(function() {
            ...
            var quantity = parseFloat($('#amount-' + rowIndex).val()) || 0;
    ...
    $(document).ready(function() {
        ...
        $('input[name^="purchase_price"]').on('input', function() {
            ...
            if (taxaValue != 0) {
                // Calculate VAT (20% of the product price)
