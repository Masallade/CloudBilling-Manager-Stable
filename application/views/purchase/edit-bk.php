                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6 cmp-pnl">
                            ...
                            <div class="frmSearch col-sm-6"><label for="cst"
                                        ...
                                        <input type="text" autofocus class="form-control" name="cst" id="supplier-name"
                                    ...
                                    <div class="form-group row">
                                        <div class="col-sm-6" style="margin-top: -20px"><label for="invociedate"
                                       ...
                                       <div class="col-sm-6">
                                           <input type="submit" style="float:right; padding:5px; margin-top:20px;"
                                           class="btn btn-success sub-btn" 
                                           value="Print Purchase Order"
                ...
                <div id="saman-row">
                    ...
                    <tbody>
                        ...
                        foreach ($products as $row) {
                            ...
                            <td><input type="text" id="productname-' .  $i . '" class="form-control ui-autocomplete-input" name="product_name[]" placeholder="Enter Product name or Code"  value="' . $row['product'] . '"autocomplete="off">
                            </td>
                            ...
                            id="packing_type"name="packing_type[]">
                            ...
                            <button type="button" data-rowid="' . $i . '" class="btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                            </td>
                        ...
                        if($i<20){ 
                                        for($k=$i; $k< 20; $k++){
                                                      echo '<tr>
                <td><input type="text" id="productname-' .  $k . '" class="form-control ui-autocomplete-input" name="product_name[]" placeholder="Enter Product name or Code"  autocomplete="off">
                            </td>
                            ...
                            <td class="text-center">
                            <button type="button" data-rowid="' . $k . '" class="btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                            </td>
                            ...
                            <input type="hidden" name="unit[]" id="unit-' . $k. '">   <input type="hidden" name="hsn[]" id="unit-' . $i . '" >
                            </tr>
                            ';
                                        }
