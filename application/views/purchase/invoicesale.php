...
<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"> Purchase Report By Category </h4>
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-3">purchase Date Between:</div>
                    <div class="col-md-2">
        ...
        <hr>
        <table id="purchase" class="table table-striped table-bordered zero-configuration ">
            <thead>
                <tr>
                    <th><?php echo ' PO # '; ?></th>
                    <!-- <th><?php echo 'A/C'; ?></th>   -->
...
<div id="Mypurchase" style="margin:0 auto; min-height:200px; width:98%; display:none;"></div>
</div>
</div>
...
<div id="delete_model" class="modal fade">
    <div class="modal-dialog">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title"><?php echo $this->lang->line('Delete purchase') ?></h4>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close"><span
                    aria-hidden="true">&times;</span></button>
                </div>
                <div class="modal-body">
                    <p><?php echo $this->lang->line('delete this purchase') ?> ?</p>
                </div>
    ...
    <!--change added by me-->
<form method="POST" id="form_for_export" action="<?php echo site_url('purchase/stock_report_export')?>" target="_blank">
  ...
  <form method="POST" id="dform_for_export" action="<?php echo site_url('purchase/daily_break_down_sheet_export')?>" target="_blank">  
...
if(fields=="" && upfields==""){
  ...
  $('#form_for_export').submit();
      ...
      $('#dbreak_down_report').click(function () {
        ...
        //url="<?php echo site_url('purchase/daily_break_down_sheet_export?ids=')?>"+fields;

        $('#dform_for_export').submit();
    // window.open(url, '_blank');

    //   window.location.href = baseurl + "pos_purchase/extended";
    ...
    function draw_data(start_date = '', end_date = '', start_cat='', end_cat='') {
        ...
        var tables =      $('#purchase').DataTable({
            ...
            'order': [],
            'ajax': {
                'url': "<?php echo site_url('purchase/ajax_sale_list')?>",
                'type': 'POST',
                'data': {
...
$('#purchase tbody').off('click', 'tr').on( 'click', 'tr', function () {
