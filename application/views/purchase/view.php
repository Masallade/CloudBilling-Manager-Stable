            ...
            <div id="invoice-template" class="card-body">
                    ...
                    <div class="col-lg-12">
                        ...
                        if ($invoice['status'] != 'canceled') { ?>
                            ...
                            <div class="title-action">
                                ...
                                <?php
                                if ($invoice['status'] != 'paid' && $invoice['verified'] != 'Verified') { ?>
                                    <a href="<?php echo 'edit?id=' . $invoice['iid']; ?>" class="btn btn-warning" title="Edit Order"><i class="fa fa-pencil"></i> <?php echo $this->lang->line('Edit Order') ?> </a>
                                <?php } ?>


                                <?php if ($invoice['status'] != 'paid') { ?>
                                    <a href="#part_payment" data-toggle="modal" data-remote="false" data-type="reminder" class="btn btn-large btn-success" title="Make Payment"><span class="fa fa-money"></span> <?php echo $this->lang->line('Make Payment') ?> </a>
                                <?php } ?>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-primary dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Send Email">

                                        <span class="fa fa-envelope-o"></span> <?php echo $this->lang->line('Send') ?>

                                    </button>

                                    <div class="dropdown-menu"><a href="#sendEmail" data-toggle="modal" data-remote="false" class="dropdown-item sendbill" data-type="purchase"><?php echo $this->lang->line('Purchase Request') ?></a>
                                ...
                                <div class="btn-group">
                                    ...
                                    <button type="button" class="btn btn-blue dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Send SMS">

                                        <span class="fa fa-mobile"></span> SMS

                                    </button>

                                    <div class="dropdown-menu"><a href="#sendSMS" data-toggle="modal" data-remote="false" class="dropdown-item sendsms" data-type="purchase"><?php echo $this->lang->line('Purchase Request') ?></a>
                                ...
                                <div class="btn-group ">
                                    ...
                                    <button type="button" class="btn btn-success btn-min-width dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false" title="Print Order">
                                        <i class="fa fa-print"></i> <?php echo $this->lang->line('Print Order') ?>

                                    </button>

                                    <div class="dropdown-menu">

                                        <a class="dropdown-item" href="<?= base_url('purchase/purchase_export?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>"><?php echo $this->lang->line('Print') ?></a>

                                        <div class="dropdown-divider"></div>

                                        <a class="dropdown-item" href="<?= base_url('purchase/purchase_export?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>&d=1"><?php echo $this->lang->line('PDF Download') ?></a>

                                    </div>

                                </div>

                                <a href="<?php echo $link; ?>" class="btn btn-primary" title="Public Preview"><i class="fa fa-globe"></i> <?php echo $this->lang->line('Public Preview') ?>

                                </a>


                                <!-- <?php if ($invoice['status'] != 'paid') { ?>
                                    <a href="#pop_model" data-toggle="modal" data-remote="false" class="btn btn-large btn-success" title="Change Status"><span class="fa fa-retweet"></span> <?php echo $this->lang->line('Change Status') ?></a>
                                <?php } ?>

                                <a href="#cancel-bill" class="btn btn-danger" id="cancel-bill_p"><i class="fa fa-minus-circle"> </i> <?php echo $this->lang->line('Cancel') ?>
                ...
                <div id="invoice-company-details" class="row mt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p class="pb-1">
                            <?php echo prefix(2) . $invoice['tid']; ?>
                        </p>
                        <!-- <p class="pb-1">
                            <?php echo $this->lang->line('Reference') . ': ' . $invoice['refer']; ?>
                        </p> -->
                        <p class="pb-1">
                            Reference #: <?php echo $invoice['invoice_ref']; ?>
                        </p>
                ...
                <div id="invoice-customer-details" class="row pt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                        ...
                        <ul class="px-0 list-unstyled">
                            ...
                            <li class="text-bold-800"><a href="<?php echo base_url('supplier/view?id=' . $invoice['cid']) ?>"><strong class="invoice_a"><?php echo $invoice['name'] . '</strong></a></li><li>' . $invoice['address'] . '</li><li>' . $invoice['city'] . ',' . $invoice['country'] . '</li><li>' . $this->lang->line('Phone') . ': ' . $invoice['phone'] . '</li><li>' . $this->lang->line('Email') . ': ' . $invoice['email']; ?>
                        ...
                        <div class="table-responsive col-sm-12">
                                ...
                                <thead>
                                    ...
                                    <?php if ($invoice['taxstatus'] == 'cgst') { ?>
                                        ...
                                        <tr>
                                            ...
                                            <th class="text-xs-left"><?php echo $this->lang->line('Unit_Rate') ?></th>
                                    ...
                                    <?php $c = 1;
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            echo '<tr>
                                                    ...
                                                    <td>' . amountExchange($row['purchase'], 0, $this->aauth->get_user()->loc) . '</td>
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <th class="text-xs-left"><?php echo $this->lang->line('Unit_Tax') ?></th>
                                ...
                                <tbody>
                                    <?php
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            <td>' . amountExchange($row['tax'], 0, $this->aauth->get_user()->loc) . '</td>
                                    ...
                                    <!-- <?php $c = 1;
                                            ...
                                            foreach ($products as $row) {
                                                ...
                                                echo '<tr>
                                                        ...
                                                        <td>' . (int)$row['qty'] . ' / ' . $row['qty'] / $row['unit'] . '</td>
            ...
            <div class="modal-body">
                ...
                <form class="payment">
                    ...
                    <div class="row mb-1">
                        ...
                        <div class="col">
                            <div><strong>Rmeaining Amount:</strong> <?php echo $this->config->item('currency') ?> <?php echo $rming ?></div>

                            <div class="input-group">

                                <div class="input-group-addon"><?php echo $this->config->item('currency') ?></div>

                                <input type="number" class="form-control" placeholder="Total Amount" name="amount" id="rmpay" value="<?php echo $rming ?>" max="<?php echo $rming ?>">
                        ...
                        <div class="col">
                            ...
                            <div class="input-group mt-2">
                                ...
                                <input type="text" class="form-control required" id="tsn_date" placeholder="Billing Date" name="paydate" value="<?php echo dateformat($this->config->item('date')); ?>">
                        ...
                        <div class="col mb-1"><label for="pmethod"><?php echo $this->lang->line('Payment Method') ?></label>
                            ...
                            <select name="account" class="form-control">
                                ...
                                <?php foreach ($acclist as $row) {
                                    ...
                                    echo '<option value="' . $row['id'] . '" ' . ($row['id'] == 2 ? 'selected' : '') . '>' . $row['holder'] . ' / ' . $row['acn'] . '</option>';
                                }
            ...
            <div class="modal-body">
                ...
                <form class="cancelbill">
                    ...
                    <div class="modal-footer">
                        ...
                        <button type="button" class="btn btn-primary" id="send"> <?php echo $this->lang->line('Cancel') ?></button>
