<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"> Transection By Supplier </h4>
        ...
        <div class="card-content">
            ...
            <div class="card-body">
            <form method="POST" id="stock_return_report" action="<?php echo site_url('purchase/payment_date_report') ?>" target="_blank">
        <div class="row">
        ...
        <!-- Your other content goes here -->
                ...
                <div class="container-fluid">
                    <div class="row">
                        ...
                        <div class="col-sm-4 cmp-pnl" style="margin-bottom: 25px; margin-left: 23px;">
