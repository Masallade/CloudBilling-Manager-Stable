<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Verify Purchase Orders</h4>
        ...
        <div class="card-content">
            ...
            <?php if ($this->session->flashdata('message')) {  ?>
                <div class="alert alert-danger">
                    ...
                    <div class="message">Conversion Not Available For <?php echo $this->session->flashdata('message') ?> Please Add Stock Manually. </div>
                </div>
            <?php } ?>
    ...
    <script type="text/javascript">
        document.title = "Verify Purchase Orders";
        $(document).ready(function() {
            ...
            function draw_data(start_date = '', end_date = '') {
                $('#po').DataTable({
                    ...
                    'ajax': {
                        'url': "<?php echo site_url('purchase/ajax_list_verification') ?>",
                        'type': 'POST',
                        'data': {
