<div class="card card-block">
    ...
    <div class="card card-block">
        ...
        <div class="form-group row">
            ...
            <div class="col-sm-6">
                <select name="lid" class="form-control required" required>
                    <option value=""><?php echo $this->lang->line('Select') ?> <?php echo $this->lang->line('Business Locations') ?></option>
                    <?php
                    // Only show "All" option if there are locations available and user has no location restriction
                    if (!empty($locations) && !$this->aauth->get_user()->loc) {
