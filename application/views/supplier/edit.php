            ...
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <div class="form-group row">
                 ...
                 <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="phone"
                               class="form-control margin-bottom required" name="phone1"
                               value="<?php echo $customer['phone1'] ?>">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-6">
                        <input type="text" placeholder="email"
                               ...
                               value="<?php echo $customer['email3'] ?>">
                    </div>
                </div>
...
<script>
    document.title = '<?php echo $this->lang->line('Edit supplier') ?>';
</script>