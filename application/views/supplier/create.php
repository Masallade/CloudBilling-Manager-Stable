    ...
    <div class="card">
        ...
        <div class="card-body">
            <form method="post" id="data_form" class="form-horizontal">
                ...
                <div class="form-group row">
                    <label class="col-sm-2 col-form-label" for="phone"><?php echo $this->lang->line('Phone') ?> 1</label>
                    <div class="col-sm-6">
                ...
                <div class="form-group row">
                      ...
                      <label class="col-sm-2 col-form-label" for="phone"><?php echo $this->lang->line('Phone') ?> 2</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="Phone"
                               class="form-control margin-bottom " name="phone1">
                    </div>
                </div>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label" for="email"><?php echo $this->lang->line('Email') ?> 1</label>
                ...
                <div class="form-group row">
                    ...
                    <label class="col-sm-2 col-form-label" for="email"><?php echo $this->lang->line('Email') ?> 2</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="email"
                               class="form-control margin-bottom " name="email2">
                    </div>
                </div>
                <div class="form-group row">

                    <label class="col-sm-2 col-form-label" for="email"><?php echo $this->lang->line('Email') ?> 3</label>

                    <div class="col-sm-6">
                        <input type="text" placeholder="email"
                               class="form-control margin-bottom " name="email3">
                    </div>
                </div>
...
<script>
    document.title = '<?php echo $this->lang->line('New Supplier') ?>';
</script>
