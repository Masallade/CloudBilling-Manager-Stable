                                ...
                                <div class="col-md-12">
                                    ...
                                    <ul class="list-group list-group-flush">
                                        <li class="list-group-item">
                                            <span class="badge tag-default tag-pill bg-primary float-xs-right"> <?php echo amountExchange($pamnt, 0, $this->aauth->get_user()->loc) . '</span> ' . $this->lang->line('Paid') ?>
                                        </li>
                                        <li class="list-group-item">
                                            <span class="badge tag-default tag-pill bg-danger float-xs-right"> <?php echo amountExchange($expense, 0, $this->aauth->get_user()->loc) ?></span>
