    ...
    <div class="card">
        <div class="card-header">
            <h5>
                ...
                <a href="<?php echo base_url('invoices/create_credit_note') ?>" class="btn btn-primary btn-sm rounded">
        ...
        $(document).ready(function () {
            ...
            function draw_data(start_date = '', end_date = '') {
                $('#invoices_c').DataTable({
                    ...
                    'order': [],
                    'ajax': {
                        'url': "<?php echo site_url('stockreturn/ajax_list_credits?t=2')?>",
                        'type': 'POST',
                        'data': {
