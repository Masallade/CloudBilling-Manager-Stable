<div class="content-body">
    ...
    <div class="card">
        ...
        <div class="card-header">
            ...
            <h5><?php echo $this->lang->line('Suppliers') . ' ' . $this->lang->line('Credit Notes') ?> 
                <?php if ($this->aauth->permission_new(null, 'purchaseCreditNotePO')) { ?>    
                    <a href="<?php echo base_url('purchase/create_credit_note_po') ?>"
    ...
    <script type="text/javascript">
        document.title = "PO Credit Notes";
            ...
            function draw_data(start_date = '', end_date = '') {
                ...
                $('#invoices_c').DataTable({
                    ...
                    'ajax': {
                        ...
                        'url': "<?php echo site_url('stockreturn/ajax_list_credits_po?t=2')?>",
