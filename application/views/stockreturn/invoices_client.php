<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Customer') . ' ' . $this->lang->line('Stock Return') ?>
            </h5>
        ...
        <script type="text/javascript">
            $(document).ready(function() {
                ...
                function draw_data(start_date = '', end_date = '') {
                    if ($.fn.DataTable.isDataTable('#invoices_stc')) {
                        $('#invoices_stc').DataTable().destroy(); // Destroy previous instance
                    }
