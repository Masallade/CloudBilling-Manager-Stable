<div class="content-body">
    ...
    <div class="row" >
                    ...
                    <div class="col-md-2">Selected Invoices (GBP)</div>
                    ...
                    <div class="col-md-2" ><input type="button" name="break_down_report" id="break_down_report" value="Print Selected" class="btn btn-success btn-sm"/> 
                   ...
                   <!--     <div class="col-md-2">
                        ...
                        <button class="btn btn-success btn-sm post_invoices"style="display: none" id="post_invoices">Post Invoices</button>

                    <button class="btn btn-success btn-sm  " id="hidebutton">

                            

                            <span class="bulk-delete-text" id="post_invoices_button">Show POST Invoices</span>
