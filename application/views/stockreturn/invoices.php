<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5><?php echo $this->lang->line('Suppliers') . ' ' . $this->lang->line('Stock Return') ?> 
            <?php if ($this->aauth->permission_new(null, 'stockReturnManageStockReturn')) { ?>    
...
<script type="text/javascript">
    document.title = "<?php echo $this->lang->line('Suppliers') . ' ' . $this->lang->line('Stock Return') ?>";
