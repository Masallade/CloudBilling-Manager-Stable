                            ...
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div id="customer">
                                    ...
                                    <div class="clientinfo">
                                        ...
                                        <div type="text" id="customer_city"></div>
                                    </div>
                                    <div class="clientinfo">

                                        <div type="text" id="customer_country"></div>
                                    </div>

                                    <div class="clientinfo">

                                        <div type="text" id="customer_email"></div>
                                    </div>
                                    <div class="clientinfo">

                                        <div type="text" id="customer_phone"></div>
                                    </div>
                                    <hr><br><br><?php echo $this->lang->line('Warehouse') ?> <select id="s_warehouses"
