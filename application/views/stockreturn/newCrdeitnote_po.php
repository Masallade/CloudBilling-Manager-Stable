...
<div class="content-body">
  ...
  <label for="pamt_terms"> Include Payment Terms and Conditions</label>-->
                        ...
                        <div class="col-sm-5 cmp-pnl" style="margin-top:-35px">
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row" style="margin-bottom:0px !important;">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="cst" class="caption">Search PO</label>
                                        <div class="input-group">
                                            <div class="input-group-addon">
                                                <span class="icon-bookmark-o" aria-hidden="true"></span>
                                            </div>
                                            <input type="text" class="form-control" name="cst" id="supplier-box-credit-note" placeholder="Enter PO# to search" autofocus />
                                ...
                                <div class="form-group row" style="margin-bottom:0px !important;">
                                    ...
                                    <div class="col-sm-6"><label for="invociedate" class="caption"><?php echo $this->lang->line('Invoice Date'); ?></label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="date" class="form-control required" placeholder="Billing Date" name="invoicedate" autocomplete="false">
                                        </div>
                                    </div>
                                </div>
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < 60; $i++) { ?>
                                    <tr>
                                        ...
                                        <td><input type="text" id="dpid-<?= $i; ?>" class="form-control" name="product_description[]" placeholder="<?php echo $this->lang->line('Enter Product description'); ?> (Optional)" autocomplete="off" /></td>

                                        <td><input type="text" class="form-control req inputs amnt" name="product_qty[]" value="1" id="amount-<?= $i; ?>" onkeypress="return isNumber(event)" onkeyup="rowTotal('<?= $i; ?>'), billUpyog()" autocomplete="off" value=""><input type="hidden" id="alert-<?= $i; ?>" value="" name="alert[]"></td>
                                        <td><input type="text" class="form-control req inputs prc" name="product_price[]" id="price-<?= $i; ?>" onkeypress="return isNumber(event)" onkeyup="rowTotal('<?= $i; ?>'), billUpyog()" autocomplete="off"></td>
                                        <td class="text-center"> <input type="checkbox" id="SI-<?= $i; ?>" value="0" name="SI[<?= $i; ?>]"> </td>

                                        <td>
                                            <input type="text" class="form-control vat " name="product_tax[]" id="vat-<?= $i; ?>" onkeypress="return isNumber(event)" onkeyup="rowTotal('<?= $i; ?>', false), billUpyog()" autocomplete="off">
                                        </td>
                                        ...
                                        <td><input type="text" class="form-control discount" name="product_discount[]" onkeypress="return isNumber(event)" id="discount-<?= $i; ?>" onkeyup="rowTotal('<?= $i; ?>'), billUpyog()" autocomplete="off"></td>
                    ...
                    <input type="hidden" value="stockreturn/action2_po" id="action-url">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-6">
                            ...
                            <div class="form-group row">
                                ...
                                <label class="col-sm-2 col-form-label" for="phone1"><?php echo $this->lang->line('Phone') ?></label>

                                <div class="col-sm-10">
                                    <input type="text" placeholder="Phone" class="form-control margin-bottom" name="phone1" id="mcustomer_phone1">
                                </div>
                            </div>
                            <div class="form-group row">
...
<script type="text/javascript">
    document.title = "New PO Credit Note";
