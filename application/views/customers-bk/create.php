                                ...
                                <div class="tab-pane active show" id="tab1" role="tabpanel" aria-labelledby="base-tab1">
                                    <div class="form-group row mt-1">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="name"> Customer A/C# </label>

                                        <div class="col-sm-8">
                                            <input type="text" placeholder="Customer A/C#"
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="name">Name <?php //echo $this->lang->line('Company') ?></label>
                                    ...
                                    <div class="form-group row">
                                        ...
                                        <label class="col-sm-2 col-form-label"
                                               for="address">Street <?php echo $this->lang->line('Address') ?></label>
