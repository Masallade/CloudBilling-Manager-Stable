...
<input type="hidden" name="urisegment" id="urisegment" value="<?php echo $this->uri->segment(3); ?>">
	...
	cid=0;
        ...
        $('#clientstable').DataTable({
            ...
            'ajax': {
                ...
                'type': 'POST',
                'data': {'<?=$this->security->get_csrf_token_name()?>': crsf_hash <?php if ($due) echo ",'due':true" ?>,'cid':cid }
            },
            'columnDefs': [
                {
                    'targets': [0],
