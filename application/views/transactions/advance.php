            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    <div class="row mb-1 ml-1">
                        ...
                        <div class="col-md-6"><input type="text" class="form-control" name="cst" id="customer-box" placeholder="Enter Person Name or Mobile Number to search (Optional)" autocomplete="off" /> </div>

                        <div class="col-md-2">

                            <input type="text" class="form-control" readonly="" placeholder="Invoice #" name="invocieno" value="<?php echo $lastinvoice; ?>">
                        </div>
