                            ...
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="date" class="form-control required"
                                           placeholder="Start Date" name="s_date" value="<?php echo date('Y-m-d') ?>"
                                           autocomplete="false">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="date" class="form-control required"
                                           placeholder="End Date" name="e_date" value="<?php echo date('Y-m-d') ?>"
                                            autocomplete="false">
                                </div>
                            </div>
                            <div class="form-group row">
                                ...
                                <div class="col-md-4">
                                    <input type="submit" class="btn btn-primary btn-md" value="View" target="_blank">
...
<script>
    document.title = '<?php echo $this->lang->line('Warehouse Statements') ?>';
</script>