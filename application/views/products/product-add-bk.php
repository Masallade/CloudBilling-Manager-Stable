...
<label class="col-sm-2 control-label" for="product_price"><?php echo $this->lang->line('Default TAX Rate') ?></label>
                ...
                <div class="form-group row">
                     ...
                     <label class="col-sm-2 control-label" for="product_price"><?php echo $this->lang->line('Stock Units') ?>*</label>
                    <div class="col-sm-4">
                     ...
                     <div class="form-group row">
                    <label class="col-sm-2 control-label" for="product_price"><?php echo $this->lang->line('Alert Quantity') ?></label>
                    <div class="col-sm-4">
                ...
                <div class="form-group row" style="display:none">
                    ...
                    <label style="display:none" class="col-sm-2 col-form-label"><?php echo $this->lang->line('BarCode') ?></label>
