...
<div class="invoice-box">
    <table>
        <tr>
            <td class="myco">
                <img src="<?php echo base_url('userfiles/company/' . (isset($company['logo']) ? $company['logo'] : 'default.png')) ?>"
            ...
            <td class="myw">
                <?php echo safe_lang('Product', 'Product') . ' ' . safe_lang('Statement', 'Statement'); ?>
            </td>
        </tr>
    </table>
    <br>
    <table>
        ...
        <tr>
            <td><h3><?php echo isset($company['cname']) ? htmlspecialchars($company['cname']) : ''; ?></h3>
                ...
                // Build contact line
                $contactParts = [];
                if ($phone) $contactParts[] = 'Phone: ' . htmlspecialchars($phone);
                if ($mobile) $contactParts[] = 'Mobile: ' . htmlspecialchars($mobile);
                if ($email) $contactParts[] = 'Email: ' . htmlspecialchars($email);
            ...
            <td>
                ...
                $product_code = isset($product['product_code']) ? htmlspecialchars($product['product_code']) : '';
                $warehouse = isset($cat_ware['watt']) ? htmlspecialchars($cat_ware['watt']) : '';
                $category = isset($cat_ware['catt']) ? htmlspecialchars($cat_ware['catt']) : '';
                
                echo safe_lang('Product Name', 'Product Name') . ' : ' . $product_name . '<br>';
                echo safe_lang('Product Code', 'Product Code') . ' : ' . $product_code . '<br>';
                echo safe_lang('Warehouse', 'Warehouse') . ' : ' . $warehouse . '<br>';
                echo safe_lang('Product Category', 'Product Category') . ' : ' . $category;
                ?>
            </td>
        </tr>
        </tbody>
    ...
    <table class="subtotal">
        ...
        <tr>
            ...
            <td><?php echo safe_lang('Total', 'Total') . ' ' . safe_lang('Units', 'Units') ?>:</td>
