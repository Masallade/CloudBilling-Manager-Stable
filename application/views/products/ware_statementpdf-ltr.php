...
<div class="invoice-box">
    ...
    <table>
        ...
        <tbody>
        <tr>
              <td><h3>5 Star Food Distribution Ltd.</h3>
           

                <?php echo ' Uplands B, Unit 2B-1 Blackhorse Lane'
                     . '<br>' . 'Londond' . ',' . 'E17 5QJ. UK' . '<br>Phone: ' . '0789 413 4060' . '<br> Email: ' . 'fivestarfooduk@gmail.com'; ?>
            </td>
