<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h5 class="title"> <?php echo $this->lang->line('Category') . ' ' . $this->lang->line('Products') ?> <a
            ...
            <div>
                <?php if (isset($cat[0])) {
                    ...
                    <h5 class="title"> <?php echo $this->lang->line('Sub') ?><?php echo $this->lang->line('Categories') ?>
                        <a href="<?php echo base_url('productcategory/add') ?>" class="btn btn-success btn-sm pull-right" title="<?php echo $this->lang->line('Add new'). ' ' . $this->lang->line('Category') ?>">
                    ...
                    <table id="catgtable" class="table table-striped table-bordered zero-configuration">
                        ...
                        foreach ($cat as $row) {
                            ...
                            $isLastRow = ($i == $totalRows);
                            $minusIcon = $isLastRow ? "<a href='#' data-object-id='" . $cid . "' class='btn btn-danger btn-sm delete-object2' title='Delete'><i class='fa fa-minus'></i></a>" : "<a href='#' data-object-id='" . $cid . "' class='btn btn-danger btn-sm delete-object2' title='Delete'><i class='fa fa-trash'></i></a>";
                            $plusIcon = $isLastRow ? "<a href='" . base_url("productcategory/add") . "' class='btn btn-primary btn-sm' title='" . $this->lang->line('Add new') . " " . $this->lang->line('Category') . "'><i class='fa fa-plus'></i></a>&nbsp;" : "";
                            echo "<tr>
                    <td>$i</td>
                ...
                <div class="card-body">
                    ...
                    <table id="productstable" class="table table-striped table-bordered zero-configuration">
                        ...
                        <tr>
                            ...
                            <th><?php echo $this->lang->line('Purchase Price') ?></th>
                            <th><?php echo $this->lang->line('Sale Price') ?></th>
        ...
        <script type="text/javascript">
            document.title = '<?php echo $this->lang->line('View Product Category') ?>';
