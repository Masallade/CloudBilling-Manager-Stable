...
<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Edit Quotation #<?= $quotation['tid'] ?></h4>
        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form id="quotation_form" method="post" action="<?php echo site_url('quotations/updatequotation') ?>">
                    <input type="hidden" name="quotation_id" value="<?= $quotation['tid'] ?>">
                            ...
                            <div class="bill-to-section">
                                ...
                                <div class="bill-to-container">
                                    <div class="form-group">
                                        <input type="text" class="form-control bill-to-field" name="bill_to_name" id="bill_to_name" value="<?= $quotation['name'] ?>" readonly>
                                    </div>
                                    <div class="form-group">
                                        <textarea class="form-control bill-to-field" name="bill_to_address" id="bill_to_address" rows="5" readonly>
                                            <?php
                                            $address = '';
                                            if ($quotation['address']) $address .= $quotation['address'];
                                            if ($quotation['city']) $address .= ($address ? "\n" : '') . $quotation['city'];
                                            if ($quotation['region']) $address .= ($address ? "\n" : '') . $quotation['region'];
                                            if ($quotation['country']) $address .= ($address ? "\n" : '') . $quotation['country'];
                                            echo $address;
                                            ?></textarea>
                                    </div>
                                </div>
                            ...
                            <div class="form-group">
                                ...
                                <select class="form-control" name="term" id="term">
                                    ...
                                    <?php foreach ($terms as $term): ?>
                                        <option value="<?= $term['id'] ?>" <?= ($term['id'] == $quotation['term']) ? 'selected' : '' ?>><?= $term['title'] ?></option>
                                    <?php endforeach; ?>
                                </select>
                            </div>
                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="customer_search" id="customer_search" placeholder="Type to search customer..." value="<?= $quotation['name'] ?> (<?= $quotation['company'] ?>)" required>
                                            <input type="hidden" name="customer" id="customer" value="<?= $quotation['csd'] ?>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="quotation_number" id="quotation_number" value="<?= $quotation['tid'] ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="invoicedate" id="invoicedate" value="<?= $quotation['invoicedate'] ?>" required>
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            <label for="invoiceduedate">Valid Until *</label>
                                            <input type="text" class="form-control" name="invoiceduedate" id="invoiceduedate" value="<?= $quotation['invoiceduedate'] ?>" required>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
                                    <div class="col-md-6">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" name="driver_name" id="driver_name" value="<?= $quotation['driver_name'] ?>" placeholder="Enter Driver Name">
                                        </div>
                                    </div>
                                </div>
                            </div>
                                        ...
                                        <div class="product-row">
                                            <div class="product-cell">
                                                ...
                                                <div class="product-search-container">
                                                    <input type="text" class="form-control product-search" name="product_search[]" placeholder="Search product or click to see all..." value="<?= $product['product_code'] ?>" autocomplete="off">
                                                    <input type="hidden" name="product_id[]" class="product-id" value="<?= $product['pid'] ?>">
                                                    <div class="product-suggestions" style="display: none;"></div>
                                                </div>
                                            </div>
                                            <div class="product-cell">
                                                <input type="text" class="form-control" name="product_des[]" placeholder="Enter Product description (Optional)" value="<?= $product['product_des'] ?>">
                                            </div>
                                            <div class="product-cell">
                                                <input type="number" step="0.01" class="form-control qty" name="product_qty[]" value="<?= $product['qty'] ?>">
                                            </div>
                                            <div class="product-cell">
                                                <input type="number" step="0.01" class="form-control price" name="product_price[]" value="<?= $product['price'] ?>" placeholder="0.00">
                                            </div>
                                            <div class="product-cell">
                                                <input type="number" step="0.01" class="form-control tax" name="product_tax[]" value="<?= $product['tax'] ?>" readonly>
                                            </div>
                                            <div class="product-cell">
                                                <input type="number" step="0.01" class="form-control net-tax" name="product_net_tax[]" readonly>
                                            </div>
                                            <div class="product-cell">
                                                <input type="number" step="0.01" class="form-control discount" name="product_discount[]" value="<?= $product['discount'] ?>">
                                            </div>
                                            <div class="product-cell">
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="number" step="0.01" class="form-control" name="shipping" id="shipping" value="<?= $quotation['shipping'] ?>">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="form-group">
                                <label for="ship_tax">Shipping Tax</label>
                                <input type="number" step="0.01" class="form-control" name="ship_tax" id="ship_tax" value="<?= $quotation['ship_tax'] ?>">
                            </div>
                        </div>
                    </div>
...
<script>
    $(document).ready(function() {
        document.title = 'Edit Quotation #<?= $quotation['tid'] ?>';
        let customerSearchTimeout, productSearchTimeout, allCustomersLoaded = false,
        ...
        // Initialize calculations on page load for existing data
        // Calculate net tax and subtotal for each existing row
        $('#product_tbody .product-row').each(function() {
            calculateRowTotal($(this));
        });

        // Calculate totals after all rows are processed
        setTimeout(function() {
            calculateTotals();
        }, 100);
        ...
        // Date picker
        $('#invoicedate, #invoiceduedate').datepicker({
            format: 'yyyy-mm-dd',
            autoclose: true
        });
        ...
        $('#quotation_form').submit(function(e) {
            ...
            $.ajax({
                ...
                error: function() {
                    showAlert('An error occurred while updating the quotation.', 'danger');
                }
            });
        });
    });
