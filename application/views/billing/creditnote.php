                                        ...
                                        <div class="btn-group mt-2">
                                            ...
                                            <div class="dropdown-menu">
                                                <a class="dropdown-item"
                                                   href="<?php echo 'printscreditnote?id=' . $invoice['iid'] . '&token=' . $token; ?>"><?php echo $this->lang->line('Print') ?></a>
                    ...
                    <div id="invoice-company-details" class="row mt-2">
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
                            ...
                            <ul class="px-0 list-unstyled">
                                ...
                                echo '<li class="text-bold-800">5 Star Food Distribution Ltd </li><li>Uplands B, Unit 2B-1
Blackhorse Lane </li><li>' . $loc['region'] . ', UK  -  E17 5QJ</li><li>' . $this->lang->line('Phone') . ' : 0203 417 7077</li><li> ' . $this->lang->line('Email') . ' : fivestarfooduk@gmail.com' ?>
                                </li>
                            </ul>
                        </div>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['qty']*$row['price']+$row['tax']*$row['qty'], $invoice['multi'], $invoice['loc']) . '</td>
                        </tr>';
