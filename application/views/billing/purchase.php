                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-12 text-xs-right">
                                        ...
                                        <div class="btn-group mt-2">
                                            ...
                                            <button type="button" class="btn btn-primary btn-min-width dropdown-toggle" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false"><i class="icon-print"></i> <?php echo $this->lang->line('Print Order') ?>

                                            </button>

                                            <div class="dropdown-menu">

                                                <a class="dropdown-item" href="<?= base_url('purchase/purchase_export?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>" target="_blank"><?php echo $this->lang->line('Print') ?></a>

                                                <div class="dropdown-divider"></div>

                                                <a class="dropdown-item" href="<?= base_url('purchase/purchase_export?id=' . $invoice['iid'] . '&token=' . $validtoken); ?>&d=1" target="_blank"><?php echo $this->lang->line('PDF Download') ?></a>
                    ...
                    <div id="invoice-company-details" class="row mt-2">
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                            ...
                            <ul class="px-0 list-unstyled">
                                ...
                                echo '<li class="text-bold-800">' . $loc['cname'] . '</li><li>' . $loc['address'] . ',' . $loc['city'] . ',</li><li>' . $loc['region'] . ',' . $loc['country'] . ' -  ' . $loc['postbox'] . '</li><li>' . $this->lang->line('Phone') . ' : ' . $loc['phone'] . '</li><li> ' . $this->lang->line('Email') . ' : ' . $loc['email'] ?>
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-right mt-2">
                            ...
                            <p class="pb-1">' . $this->lang->line('Reference') . '#' . $invoice['invoice_ref'] . '</p>'; ?>
                    ...
                    <div id="invoice-customer-details" class="row pt-2">
                        ...
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left">
                            ...
                            <ul class="px-0 list-unstyled">
                                ...
                                <li class="text-bold-800"><strong class="invoice_a"><?php echo $invoice['name'] . '</strong></li><li>' . $invoice['address'] . ',' . $invoice['city'] . ', ' . $invoice['region'] . ',' . $invoice['country'] . ', ' . $invoice['postbox'] . '</li><li>' . $this->lang->line('Phone') . ' : ' . $invoice['phone'] . '</li><li>' . $this->lang->line('Email') . ' : ' . $invoice['email']; ?>
                        ...
                        <div class="table-responsive col-sm-12">
                                ...
                                <tbody>
                                    ...
                                    <?php $c = 1;
                                        ...
                                        foreach ($products as $row) {
                                            ...
                                            echo '<tr><td colspan=6>' . $row['product_des'] . '</td></tr>';
                            ...
                            ?>
                                ...
                                <tr>
                                    ...
                                    <th class="text-xs-left">Quantity / Pallets</th>
