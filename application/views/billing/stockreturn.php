                    ...
                    <div id="invoice-company-details" class="row mt-2">
                        <div class="col-md-6 col-sm-12 text-xs-center text-md-left"><p></p>
                            ...
                            <ul class="px-0 list-unstyled">
                                ...
                                echo '<li class="text-bold-800">'.$company['cname'] .'</li><li>' . $company['address'] . ' ' . $company['city'] . ' ' . $company['region'] . ', ' . $company['postbox'] . ', ' . $company['country'] . '
                                </li><li>' . $this->lang->line('Phone') . ' : ' . $company['phone'] .',' . $this->lang->line('Mobile') . ' : ' . $company['mobile'] .' </li>
                                <li>' . $this->lang->line('Email') . ' : ' . $company['email'] ?>
                                </li>
                            </ul>
                        </div>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['tax']*$row['qty'], $invoice['multi'], $invoice['loc']) . ' (' . amountFormat_s($row['tax']) . ')</td>
                            ...
                            <td>' . amountExchange($row['qty']*$row['price'], $invoice['multi'], $invoice['loc']) . '</td>
                        </tr>';
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-5 col-sm-12">
                                ...
                                <div class="table-responsive">
                                    <table class="table">
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-xs-right"><?php echo amountExchange($total_vat, $invoice['multi'], $invoice['loc']) ?></td>
                                        </tr>
                                        <tr>
                                ...
                                <div class="text-xs-center">
                                    ...
                                    <?php echo '<img src="' . $logo . '" alt="signature" class="height-100"/>
                                    <h6>(' . $employee['name'] . ')</h6>
