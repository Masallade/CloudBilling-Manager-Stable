<div class="content-body">
   ...
   <div class="col-sm-12">
                ...
                <table id="invoices" class="table-bordered zero-configuration " style="width:100%;">
					...
					<?php if(!empty($list)){ ?>
                    <tbody id="InvoiceTbl">
				<!--	<?php $k = 0;foreach($list as $invoices): $remaining = 0;
						$no++;    ?>
		   ...
		   <td><?php $remaining = ($invoices->total - $invoices->pamnt);  echo amountExchange($remaining, 0, $this->aauth->get_user()->loc); ?></td>
...
function selectGCustomer(cid, cname, cadd1, cadd2, ph, email,balance, discount = 0) {
    ...
    $('.date30').datepicker({autoHide: true, format: 'dd-mm-yyyy'});
