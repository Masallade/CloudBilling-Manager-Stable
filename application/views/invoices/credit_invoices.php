                            ...
                            <table class="table-responsive tfr">
                              ...
                              <tr class="item_header bg-gradient-directional-blue white">
                                ...
                                foreach ($products as $row) { 
                                    ...
                                    if($row['serial'] == 1){ $chk =  " checked "; }else{ $chk = "  "; }
                                   echo '<tr >
...
<button type="button" data-rowid="' . $k . '" class="btn-sm btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                  ...
                  echo'  </tr> ';
                        ...
                        <input type="hidden" value="invoices/editaction_credit_invoice" id="action-url">
                        <input type="hidden" value="search" id="billtype">
                        <input type="hidden" value=" <?php  if($i<30){echo '30';}else{echo $i-1;} ?> " name="counter" id="ganak">
