<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title"> Vat Collection </h4>
            ...
            <div class="card-body">
                <div class="row">
                    ...
                    <div class="col-md-2">
                     ...
                     <div class="row">
                     <div class="col-md-8">
                     <label  for="daypass_check">Include Daypass</label>
                     </div>
                     <div class="col-md-4">
                      <input type="checkbox" name="daypass_check" id="daypass_check"  value="1" class="form-control form-control-sm"
                        autocomplete="off"/>
                        </div>
                     </div>
...
<div id="delete_model" class="modal fade">
    ...
    <!--change added by me-->
<form method="POST" id="form_for_export" action="<?php echo site_url('invoices/vat_collect_export')?>" target="_blank">
