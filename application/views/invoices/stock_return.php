<div class="content-body">
    <div class="card">
        <div class="card-header">
            <h4 class="card-title">Credit Invoice</h4>
            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    ...
                    <div class="row">
                                ...
                                <div id="customer" style="margin-top:-20px">
                                    <div class="clientinfo">
                                        ...
                                        <?php echo '  <input type="hidden" name="customer_id" id="customer_id" value="' . $invoice['csd'] . '">
                                            <input type="text" id="customer_name" class="form-control" name="customer_name" rows="1" cols="10" value="' . $invoice['cust_name'] . '"> <br>
                                    ...
                                    <div class="form-group row" style="margin-bottom:5px;">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <select class="form-control"
                                                id="invoiceType" name="invoiceType" disabled>
                                                <option value="INVOICE" <?php if ($invoice['inv_type'] == 'INVOICE') { ?> selected <?php } ?>> Invoice </option>
                                                <option value="DAYPASS" <?php if ($invoice['inv_type'] == 'DAYPASS') { ?> selected <?php } ?>> DAY PASS </option>
                                            </select>
						...
						<td><input id="dpid-' . $i . '" class="form-control" name="product_description[]" value=" ' . $row['product_des'] . ' " placeholder="" autocomplete="off">
                        ...
                        <input type="hidden" value="invoices/editaction4" id="action-url">
             ...
             $(document).ready(function() {
                $('input[name^="product_qty"]').on('input', function() {
                    ...
                    if (!isNaN(value) && value > 0) {
                        $(this).val(value); // Allow only positive numbers
                    } else {
                        $(this).val(''); // Clear input if invalid or <= 0
                    }
                });
            });
            $(document).ready(function() {
