            ...
            <div class="card-body">
                <form method="post" id="data_form">
                    ...
                    <div class="row">
                        ...
                        <div class="col-sm-4 cmp-pnl" style="margin-top:-30px">
                                ...
                                <div id="customer" style="margin-top:-20px">
                                    <div class="clientinfo">
                                        ...
                                        <?php echo '  <input type="hidden" name="customer_id" id="customer_id" value="' . $invoice['csd'] . '">
                                            <input type="text" id="customer_name" class="form-control d-none" name="customer_name" rows="1" cols="10" value="' . $invoice['cust_name'] . '"> <br>
                            

                                <textarea id="customer_address1" class="form-control" name="customer_address1" rows="3" cols="21"> ' . $invoice['cust_address'] . '&#10;' . $invoice['cust_city'] . '&#10;' . $invoice['cust_postcode'] . '                                           </textarea >
                            </div>

                            '; ?>
                                        <hr>
                                        <div id="customer_pass"></div>
                                        <input type="checkbox" id="pamt_terms" name="pamt_terms" value="1" <?php if ($invoice['pamt_terms'] == '1') {
                                                                                                                echo 'checked';
                                                                                                            } ?>>
                            ...
                            <div class="col-sm-4 cmp-pnl"></div>
                            <div class="col-sm-4 cmp-pnl" style="margin-top:-35px">
                                        ...
                                        <div class="col-sm-6">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="date" class="form-control required"
                                                    ...
                                                    autocomplete="false"
                                                    value="<?php echo date('Y-m-d', strtotime($invoice['invoicedate'])) ?>">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="form-group row" style="margin-bottom:0px !important;">
                                    ...
                                    <div class="col-sm-6"><label for="cst"
                                            class="caption"><?php echo 'Driver Name'; ?></label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control " name="driver_name"
                                                value="<?php echo $invoice['driver_name']; ?>" />
                                    ...
                                    <div id="customer-box-result"></div>
                                    <div class="col-sm-6"><label for="invocieno"
                                            class="caption"><?php echo 'Vehicle Number' ?></label>

                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-file-text-o"
                                                    aria-hidden="true"></span></div>
                                            <input type="text" class="form-control " name="vehicle_no"
                                                value="<?php echo $invoice['vehicle_no']; ?>" />
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row" style="margin-bottom:2px;">
                                    ...
                                    <div class="col-sm-12">
                                        <label for="invoiceType" class="caption" style="margin-top:2px;">Invoice Type</label><br>
                                        <input type="radio" id="invoice_t" name="invoiceType" value="INVOICE" <?php if ($invoice['inv_type'] == 'INVOICE') {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                                        <label for="invoice_t">INVOICE</label> &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;
                                        <input type="radio" id="invoice_t2" name="invoiceType" value="DAYPASS" <?php if ($invoice['inv_type'] == 'DAYPASS') {
                                                                                                                    echo 'checked';
                                                                                                                } ?>>
                                        ...
                                        <div class="form-group ">
                                            <div class="col-sm-8 px-0">
                                                ...
                                                <input type="submit" style=" padding:8px 20px; margin-top:20px;" class="btn btn-info sub-btn"
                                                    value="Save"
                                                    id="submit-data-noprint"
                                                    data-loading-text="Updating...">
                                                <input type="submit" style=" padding:8px 20px; margin-top:20px;" class="btn btn-success sub-btn"
                                                    value="Update & Print Invoice"
                                                    id="submit-data"
                                                    data-loading-text="Updating...">
                                            </div>
                                        </div>
                            ...
                            <table class="table-responsive tfr">
                                <thead>
                                    ...
                                    <tr class="item_header bg-gradient-directional-blue white">
                                        ...
                                        <th width="5%" class="text-center">Price <?php //echo $this->lang->line('Rate') 
                                                                                    ?></th>
                                        <th width="10%" class="text-center">Special Notes</th>
                                        <th width="5%" class="text-center">VAT</th>
                                        <th width="5%" class="text-center">Net VAT <?php //echo $this->lang->line('Tax') 
                                                                                    ?></th>
                                ...
                                <tbody>
                                    ...
                                    foreach ($products as $row) {
                                        ...
                                        if ($row['qty'] > 0) {
                                            ...
                                            echo '<tr >
                                        <td><input type="text" class="form-control inputs ui-autocomplete-input" id="productname-' . $i . '" name="product_name[]"  value="' . $row['product'] . '">
                                        </td>
                                        <td><input id="dpid-' . $i . '" class="form-control" name="product_description[]" value=" ' . htmlspecialchars($row['product_des']) . ' " placeholder="" autocomplete="off">
                                        <td><input type="text" class="form-control req inputs amnt" name="product_qty[]" id="amount-' . $i . '"
                                        ...
                                        <td><input type="text" class="form-control req inputs prc" name="product_price[]" id="price-' . $i . '"
                                                ...
                                                <input type="hidden" name="weight_qty[]" id="w_qty-' . $i . '" value=" ' . htmlspecialchars($row['weight_qty']) . ' ">
                                                
                                                <td class="text-center">  <input type="checkbox" id="SI-' . $i . '" ' . $chk . '  value="0" name="SI[' . $i . ']">  </td>
                                                <input type="hidden" name="cost[]" id="cost-' . $i . '" value="">
                                        <td> <input type="text" class="form-control vat" name="product_tax[]" id="vat-' . $i . '"
                                                    onkeypress="return isNumber(event)" onkeyup="rowTotal(' . $i . '), billUpyog()"
                                                    autocomplete="off"  value="' . amountFormat_general($row['qty'] > 0 ? $row['tax'] / $row['qty'] : $row['tax']) . '"></td>
                                        ...
                                        <td class="text-center"><span class="currenty">' . $this->config->item('currency') . '</span>
                                        ...
                                        <input type="hidden" class="pdIn" name="pid[]" id="pid-' . $i . '" value="' . $row['pid'] . '">
                                            ...
                                            if (isset($row['alert'])) echo '<input type="hidden" id="alert-' . $i . '" value="' . $row['alert'] . '"
                                                                               name="alert[]">';
                                            if (isset($row['vattype'])) echo '<input type="hidden" id="vattype-' . $i . '" value="' . $row['vattype'] . '" name="vattype[]">';
                                            if (isset($row['cost'])) echo '<input type="hidden" id="cost-' . $i . '" value="' . $row['cost'] . '" name="cost[]">';
                                    ...
                                    if ($i < 30) {
                                        for ($k = $i; $k < 30; $k++) {
                                            echo '<tr>
                                                    <td><input type="text" class="form-control inputs ui-autocomplete-input " name="product_name[]"  id="productname-' . $k . '"  value="">
                                                    </td>
                                                    <td><input type="text" id="dpid-' . $k . '" class="form-control" name="product_description[]" value="" autocomplete="off">
                                                    <td><input type="text" class="form-control req inputs amnt" name="product_qty[]" id="amount-' . $k . '"
                                                            onkeypress="return isNumber(event)" onkeyup="rowTotal(' . $k . '), billUpyog()"
                                                            autocomplete="off" value="" ><input type="hidden" name="old_product_qty[]" value="" ></td>
                                                    <td><input type="text" class="form-control req inputs prc" name="product_price[]" id="price-' . $k . '"
                                                            onkeypress="return isNumber(event)" onkeyup="rowTotal(' . $k . '), billUpyog()"
                                                            autocomplete="off" value=""></td>
                                                            <input type="hidden" name="weight_qty[]" id="w_qty-' . $k . '" value="">
                                                            
                                                            <td class="text-center">  <input type="checkbox" id="SI-' . $k . '"  value="0"   name="SI[' . $k . ']">  </td>
                                                            
                                                            
                                                    <td> <input type="text" class="form-control  vat" name="product_tax[]" id="vat-' . $k . '"
                                                                onkeypress="return isNumber(event)" onkeyup="rowTotal(' . $k . '), billUpyog()"
                                                                autocomplete="off"  value=""></td>
                                                    <td class="text-center" id="texttaxa-' . $k . '"></td>
                                                    <td><input type="text" class="form-control  discount" name="product_discount[]"
                                                            onkeypress="return isNumber(event)" id="discount-' . $k . '"
                                                            onkeyup="rowTotal(' . $k . '), billUpyog()" autocomplete="off"  value=""></td>
                                                    <td class="text-center"><span class="currenty">' . $this->config->item('currency') . '</span>
                                                        <strong><span class="ttlText" id="result-' . $k . '"></span></strong></td>
                                                    <td class="text-center">
                                                    <button type="button" data-rowid="' . $k . '" class="btn-sm btn-danger removeProd" title="Remove"> <i class="fa fa-minus-square"></i> </button>
                                                    </td>
                                                    <input type="hidden" name="taxa[]" id="taxa-' . $k . '" value="">
                                                    <input type="hidden" name="disca[]" id="disca-' . $k . '" value="">
                                                    <input type="hidden" class="ttInput" name="product_subtotal[]" id="total-' . $k . '" value="">
                                                    <input type="hidden" class="pdIn" name="pid[]" id="pid-' . $k . '" value="">
                                                    <input type="hidden" name="unit[]" id="unit-' . $k . '" value="">
                                                    <input type="hidden" name="vattype[]" id="vattype-' . $k . ' " value="">
                                                    <input type="hidden" name="cost[]" id="cost-' . $k . '" value="">
                                                    <input type="hidden" name="hsn[]" id="unit-' . $k . '" value="">  <input type="hidden" name="serial[]" id="serial-' . $k . '" value="">';
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        <td colspan="7" class="reverse_align"><input type="hidden"
                                    ...
                                    <tr class="sub_c" style="display: table-row;">
                                        <td colspan="2" style="display:none;"><?php echo $this->lang->line('Payment Terms') ?> <select
                                                name="pterms"
                        ...
                        <input type="hidden" value=" <?php if ($i < 30) {
                                                            echo '30';
                                                        } else {
                                                            echo $i - 1;
                                                        } ?> " name="counter" id="ganak">
