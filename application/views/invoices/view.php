            ...
            <div id="invoice-template" class="card-body">
                ...
                <div id="invoice-company-details" class="row mt-2">
                    ...
                    <div class="col-md-6 col-sm-12 text-xs-center text-md-right">
                        ...
                        <p> Invoice Type: <?php echo $invoice['inv_type']; ?></p>
...
<th scope="row">' . $c . '</th>
                            ...
                            <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                    ...
                                    foreach ($products as $row) {
                                        ...
                                        echo '<tr>
                                                    <th scope="row">' . $c . '</th>
                                                    <td>' . $row['product'] . '</td><td>'. $row['product_des'] .'</td>                           
                                                    <td>' . amountExchange($row['price'], 0, $this->aauth->get_user()->loc) . '</td>
                                                    <td>' . amountFormat_general($row['qty']) . $row['unit'] . '</td>
                                                    <td>' . amountFormat_general($row['totaltax'], 0, $this->aauth->get_user()->loc) . ' </td>
                                                    <td>' . amountExchange($row['totaldiscount'], 0, $this->aauth->get_user()->loc) . '</td>
                                                    <td>' . amountExchange($row['subtotal'], 0, $this->aauth->get_user()->loc) . '</td>
                                                </tr>';
                        ...
                        <div class="col-md-7 col-sm-12 text-xs-center text-md-left">
                            ...
                            <div class="row">
                                <div class="col-md-8"><p
                                    ...
                                    <p style="display:none;" class="lead"><?php echo $this->lang->line('Payment Method') ?>: <u><strong
                                                    id="pmethod"><?php echo $this->lang->line($invoice['pmethod']) ?></strong></u>
                                    </p>

                                    <p  style="display:none;" class="lead mt-1"><br><?php echo $this->lang->line('Note') ?>:</p>
                                    <code>
                                  ...
                                  <!--   <tr>
                                   ...
                                   <tr class="bg-grey bg-lighten-4">
                                        ...
                                        <td class="text-bold-800 text-xs-right"> <?php $myp = '';
                                            $rming = $this->aauth->get_customer($invoice['cid'])->balance;
                                            if ($rming < 0) {
                                                $rming = 0;

                                            }
                                            echo ' <span id="paydue">' .amountExchange( $rming)  . '</span></strong>'; ?></td>
                                    </tr> -->
                                    </tbody>
                                </table>
                            </div>
                ...
                <div id="invoice-footer"><!--p class="lead"><?php echo $this->lang->line('Credit Transactions') ?>:</p-->
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-7 col-sm-12">
                            ...
                            <h6  style="display:none;"><?php echo $this->lang->line('Terms & Condition') ?></h6>
                    ...
                    <div class="row">
                        <div class="col mb-1"><label
                            ...
                            <select name="pmethod" class="form-control mb-1">
                                ...
                                <option selected value="Balance"><?php echo $this->lang->line('Client Balance') ?></option>
