        ...
        <div class="card-content">
            ...
            <div class="card-body">
                <form method="post" id="data_form" onkeydown="return event.key != 'Enter';">
                        ...
                        <div class="col-sm-4 cmp-pnl" style="margin-top:-20px">
                            <div id="customerpanel" class="inner-cmp-pnl">
                                ...
                                <div id="customer">
                                    ...
                                    <br>
                                    <input type="checkbox" id="pamt_terms" name="pamt_terms" value="1" checked>
                                    ...
                                    <select style="display:none;" id="s_warehouses" class="form-control round">
                            ...
                            <table class="table-responsive tfr">
                                <tbody>
                                    <tr class="sub_c px-1" style="display: table-row;">
                                        <td class="reverse_align"><strong><?php echo $this->lang->line('Total Tax') ?></strong>
                                        </td>
                                        <td align="center"><span class="currenty lightMode"><?= $this->config->item('currency'); ?></span>
                                    ...
                                    <tr class="sub_c px-1" style="display: table-row;">
                                        ...
                                        <td align="center"><span class="currenty lightMode"><?php echo $this->config->item('currency');
                                    ...
                                    <?php if ($show_profit_per == 1) { ?>
                                        <tr class="sub_c px-1" style="display: table-row;">
                                            <td class="reverse_align"><strong>Estimated Profit</strong></td>
                                            <td align="center">
                                                <span id="estimated_profit" class="lightMode">0.00</span>
                                    ...
                                    <tr>
                                        ...
                                        <td align="left"><input type="text" name="total" class="form-control" id="invoiceyoghtml" style=" text-align: center;" readonly="">
                                    </tr>
                                </tbody>
                            </table>
                        </div>
                        <div class="col-sm-5 cmp-pnl" style="margin-top:-35px">
                            <div class="inner-cmp-pnl">
                                ...
                                <div class="form-group row" style="margin-bottom:0px !important;">
                                    ...
                                    <div class="col-sm-6"><label for="cst" class="caption"><?php echo $this->lang->line('Search Client'); ?></label>

                                        <div class="input-group">
                                            <div class="input-group-addon"><span class="icon-bookmark-o" aria-hidden="true"></span></div>

                                            <input type="text" class="form-control " name="cst" id="customer-box" placeholder="Enter Customer Name or Phone Number to search" autofocus />
                                    ...
                                    <div class="col-sm-6"><label for="invocieno" class="caption"><?php echo $this->lang->line('Invoice Number') ?></label>
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control " readonly placeholder="Invoice #" name="invocieno" value="<?php echo $lastinvoice + 1 ?>">
                                        </div>
                                    </div>
                                ...
                                <div class="form-group row" style="margin-bottom:0px !important;">
                                    ...
                                    <div class="col-sm-6">
                                        <label for="invoiceType" class="caption"> Invoice Type</label><br>
                                ...
                                <div class="form-group row" style="margin-bottom:0px !important;">
                                    ...
                                    <div class="col-sm-6"><label for="cst" class="caption"><?php echo 'Driver Name'; ?></label>
                                    ...
                                    <div id="customer-box-result"></div>
                                    <div class="col-sm-6"><label for="invocieno" class="caption"><?php echo 'Vehicle Number' ?></label>
                                ...
                                <div class="form-group row" style="margin-bottom:8px !important;">
                                    ...
                                    <div class="col-sm-12" style="margin-top:10px;">
                                        <input type="hidden" id="auto_post" value="<?= $auto_post; ?>">

                                        <input type="hidden" id="invoice_format" value="<?= $invoice_format; ?>">

                                        <input type="submit" class="btn btn-success sub-btn" value="Save" id="submit-data-noprint" data-loading-text="Creating...">

                                        <?php if ($this->aauth->permission_new(null, 'customerItemPriceList')) { ?>
                                            <a class="btn btn-warning" id="customerProducts" href=" " onclick="myFunction()" target="_blank">Customer Price List</a>
                                        <?php } ?>

                                        <input type="submit" class="btn btn-success sub-btn" value="Save & Print" id="submit-data" data-loading-text="Creating...">
                                ...
                                <div class="form-group row" style="display:none;">
                                    ...
                                    <div class="col-sm-6">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select class="form-control round" onchange="changeDiscountFormat(this.value)" id="discountFormat">
                        ...
                        <table class="table-responsive tfr">
                            ...
                            <thead>
                                <tr class="item_header bg-gradient-directional-blue white">
                                    <th width="10%" class="text-center"> <?php echo $this->lang->line('Product Code') ?></th>
                                    <th width="29%" class="text-center"> <?php echo $this->lang->line('Product Description') ?></th>
                                    <th width="5%" class="text-center"><?php echo $this->lang->line('Quantity') ?></th>
                                    <th width="5%" class="text-center"><?php echo $this->lang->line('Price') ?></th>
                                    <th width="10%" class="text-center"><?php echo $this->lang->line('Mark') ?></th>
                                    <th width="5%" class="text-center"><?php echo $this->lang->line('Tax') ?></th>
                                    <th width="5%" class="text-center"><?php echo $this->lang->line('NetTax') ?></th>
                                    <th width="5%" class="text-center"><?php echo $this->lang->line('Discount') ?></th>
                                    <th width="10%" class="text-center"><?php echo $this->lang->line('Net Amount') ?></th>
                                    <th width="5%" class="text-center"><?php echo $this->lang->line('Remove') ?></th>
                                </tr>
                            ...
                            <tbody>
                                <?php for ($i = 0; $i < 60; $i++) { ?>
                                    <tr>
                                        <td><input type="text" class="form-control inputs" name="product_name[]" placeholder="<?php echo 'Enter Product Code'; ?>" id='productname-<?= $i; ?>'>
                                        </td>

                                        <td><input type="text" id="dpid-<?= $i; ?>" class="form-control" name="product_description[]"
                                                placeholder="<?php echo $this->lang->line('Enter Product description'); ?> (Optional)" autocomplete="off" /></td>

                                        <td><input type="number" class="form-control req inputs amnt" name="product_qty[]" value="1" min="1" step="1" id="amount-<?= $i; ?>"
                                                onkeypress="return isNumber(event)" onkeyup="rowTotal('<?= $i; ?>'), billUpyog()" autocomplete="off" value="">
                                            <input type="hidden" id="alert-<?= $i; ?>" value="" name="alert[]">
                                        </td>
                                        <input type="hidden" name="cost[]" id="cost-<?= $i; ?>" value="">
                                        <td><input type="number" class="form-control req inputs prc" name="product_price[]" id="price-<?= $i; ?>"
                                                onkeypress="return isNumber(event)" onkeyup="rowTotal('<?= $i; ?>'), billUpyog()" autocomplete="off" min="0" step="1"></td>
                                        <td class="text-center"> <input type="checkbox" id="SI-<?= $i; ?>" value="0" name="SI[<?= $i; ?>]"> </td>

                                        <td>
                                            <input type="number" min="1" step="1" class="form-control vat " name="product_tax[]" id="vat-<?= $i; ?>"
                                                onkeypress="return isNumber(event)" onkeyup="rowTotal('<?= $i; ?>', false), billUpyog()" autocomplete="off">
                                        </td>
                                        <td class="text-center" id="texttaxa-<?= $i; ?>">0</td>
                                        <td><input type="number" class="form-control discount" name="product_discount[]" onkeypress="return isNumber(event)" id="discount-<?= $i; ?>" min="0" step="1" onkeyup="rowTotal('<?= $i; ?>'), billUpyog()" autocomplete="off"></td>
                                        <td class="text-center"><span class="currenty"><?= currency($this->aauth->get_user()->loc); ?></span>
                                            <strong><span class='ttlText' id="result-<?= $i; ?>">0</span></strong>
                                        </td>
                                        ...
                                        <input type="hidden" class="ttInput" name="product_subtotal[]" id="product_subtotal-<?= $i; ?>" value="0">
                                ...
                                <tr class="sub_c" style="display: table-row; visibility: hidden;">
                                    <td colspan="7" class="reverse_align"><input type="hidden" value="0" id="subttlform" name="subtotal"><strong><?php echo $this->lang->line('Total GST') ?></strong>
                                    </td>
                                ...
                                <tr class="sub_c" style="display: table-row; visibility: hidden;">
                                    ...
                                    <td align="center" colspan="2"><span class="currenty lightMode">
                                ...
                                <tr class="sub_c" style="display: none;">
                                    ...
                                    <td align="center" colspan="2"><input type="text" class="form-control shipVal" onkeypress="return isNumber(event)" placeholder="Value" name="shipping" autocomplete="off" onkeyup="billUpyog()">
                                ...
                                <tr class="sub_c" style="display: none;">
                                    ...
                                    <td align="center" colspan="2"><input type="text" class="form-control form-control-sm discVal" onkeypress="return isNumber(event)" placeholder="Value" name="disc_val" autocomplete="off" value="0" onkeyup="billUpyog()">
                    ...
                    <input type="hidden" value="<?= $this->settings->auto_post() ? 'printinvoice' : 'printinvoice_bfr_posting' ?>" id="print-url">
...
<script type="text/javascript">
    document.title = 'Create Invoices';
</script>
<script type="text/javascript">
