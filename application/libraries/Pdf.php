...
function load_split_letter($param = array('margin_top'=>40))
    {


        require_once APPPATH . 'third_party/vendor/autoload.php';

        $mpdf = new \Mpdf\Mpdf(['tempDir' => $this->temppath,'default_font' => 'bangla','mode' => 'utf-8', 'format' => 'Letter', 'margin_left' => 5, 'margin_right' => 5, 'margin_top' =>$param['margin_top'], 'margin_bottom' => 12]);
